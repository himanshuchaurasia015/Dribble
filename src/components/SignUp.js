...
const handleSubmit = (e) => {
  ...
  return (
    ...
    <div className="flex flex-col  items-center lg:items-start  mx-10  lg:my-[70px]">
      ...
      <div className="absolute left-0 text-xs text-red-500">Username has already been taken</div>
...
<input type="text" id="name" name="name" onChange={(e)=>{setName(e.target.value)}} value={name} className="lg:w-56 px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-600" />
</div>
<div className="flex flex-col">
<label for="username" className="text-sm font-medium text-gray-700">Username</label>
<div className="">
  <input type="text" id="username" name="username" onChange={(e)=>{setUsername(e.target.value)}} value={username} className="px-4 py-2 w-full rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-600" />
</div>
</div>
</div>
          <div className="flex flex-col">
            <label for="email" className="text-sm font-medium text-gray-700">Email</label>
            <input type="email" id="email" name="email" onChange={(e)=>{setEmail(e.target.value)}} value={email} className="px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-600" />
            
          </div>
          <div className="flex flex-col">
            <label for="password" className="text-sm font-medium text-gray-700">Password</label>
            <input type="password" id="password" placeholder='6+ characters' name="password" onChange={(e)=>{setPassword(e.target.value)}} value={password} className="px-4 py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-600" />

          </div>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <input type="checkbox" id="terms" name="terms" className="w-4 h-4 border border-gray-300 rounded focus:ring-1 focus:ring-blue-600" />
          ...
          <button type="submit" className="w-full lg:max-w-fit lg:px-16 lg:py-3 px-4 py-2 rounded-md bg-blue-600 text-center font-medium text-white shadow-sm hover:bg-blue-700">Create Account</button>
